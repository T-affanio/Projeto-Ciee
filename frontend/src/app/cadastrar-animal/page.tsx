  ...
  return (
    <div className="min-h-screen  p-6">
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-green-900">🐾 Zoo Dashboard</h1>
      ...
      <div className="space-y-6">
        {speciesList.map((specie, index) => (
          <div
            key={index}
            className="bg-green-900 p-6 rounded-lg shadow border-l-4 border-blue-500"
          >
            ...
            <ul className="list-disc ml-6 text-[#f1c602]">
              ...
              {specie.animals.length === 0 && (
                <li className="text-gray-400 italic">Nenhum animal cadastrado.</li>
              )}
            </ul>
          </div>
        ))}
