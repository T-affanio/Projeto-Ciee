...
import { mamiferosCarnivoros } from '@/content/mamiferosCarnivoros';
...
export const MamiferosCarnivorosPage = () => {
   ...
   return (
      <main className="p-6">
         <h1 className="text-2xl font-bold mb-4 ">Mamíferos Carnívoros</h1>
         <p className="text-gray-600 mb-6">Clique em um animal para saber mais:</p>

         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {mamiferosCarnivoros.map((animal, index) => (
...
export default MamiferosCarnivorosPage;
